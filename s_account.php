...
<nav class="navbar navbar-expand-lg navbar">
  <div class="container-fluid">
    <div class="navbar-header">
      <li><a class="btn btn-outline-info" href="s_account.php"><i class="fas fa-store" style="color:black;">&nbsp;<h4>APNA BAZAAR</h4></i></a></li>  
    </div>
...
<div class="container">
  ...
  <div class="text-block">
   <hr style="color:white;"><h3>WELCOME TO APNA BAZAAR <?php echo $name; ?></h3><hr>
  </div>
</div>
